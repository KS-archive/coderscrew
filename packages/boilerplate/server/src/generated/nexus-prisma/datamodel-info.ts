...
export default {
  uniqueFieldsByModel: {
    User: ['id', 'email', 'githubId', 'googleId', 'facebookId'],
    Post: ['id'],
  },
  embeddedTypes: [],
      ...
      types: [
        ...
        },
        {
          ...
          inputFields: [
            ...
            {
              name: 'facebookId_not_starts_with',
              description: null,
              type: {
                kind: 'SCALAR',
                name: 'String',
